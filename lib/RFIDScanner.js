...
export class RFIDScanner {
  ...
  handleStatusEvent (event) {
    ...
    // if (event.RFIDStatusEvent === RFIDStatusEvent.INVENTORY_START) {
    //   this.opened = true;
    ...
    //       this.deferWriting = false;
    //   }
    // } else if (event.RFIDStatusEvent === RFIDStatusEvent.INVENTORY_STOP) {
    //   this.opened = false;
    // }
  }
  ...
  setMode (mode, tagId = null) {
    if (rfidScannerManager != null) {
        rfidScannerManager.setMode(mode, tagId);
    }
  }
